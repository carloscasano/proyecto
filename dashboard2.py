...
#    TITULO
#****************************************************
st.title(':satellite_antenna: :blue[Catálogo Sísmico] v2')
st.divider()
#****************************************************
#    SIDEBAR
#****************************************************
...
filtered_df = df[(pd.to_datetime(df['FECHA_UTC'], format='%Y%m%d') >= add_slider[0]) & (pd.to_datetime(df['FECHA_UTC'], format='%Y%m%d') <= add_slider[1])]

# Mostrar el mapa solo si se actualizan los valores de FECHA_UTC
