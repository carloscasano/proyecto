...
vendedor       = st.sidebar.multiselect(
                        ...
                        #Aqui podría por default dejar un filtro especifico pero vamos a dejarlos todos puestos por default
                        )
...
str_qry  = '(Vendedor  == @vendedor       )' + '&'
str_qry += '(Ciudad    == @ciudad         )' + '&'
str_qry += '(Pagada    == @status_factura )' + '&'
str_qry += '(Industria == @industria      )' + '&'
str_qry += '(Cliente   == @cliente        )' + '&'
str_qry += '(Términos  == @plazo          )'
df_seleccion = df.query(str_qry)
